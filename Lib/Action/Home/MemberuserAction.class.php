...
function maiche(){
		...
		$sjblist['img_path']=$new_config_info['gz_descriptionhuyppssjj'];
		$this->assign('sjblist',$sjblist);
		$this->display('./GZphp/Tpl/Home/'.SHOUJIZHANOK.'/Memberuser_buy.html');
}
    public function index(){
		...
		$this->assign('sjblist',$sjblist);
		$this->display('./GZphp/Tpl/Home/'.SHOUJIZHANOK.'/Memberuser_index.html');
    }
	function out(){
		global $user_tel;
	...
	function epass(){
		...
		$blist['img_path']=$new_config_info['gz_descriptionhuypp'];
		$this->assign('blist',$blist);
		$this->display('./GZphp/Tpl/Home/'.SHOUJIZHANOK.'/Memberuser_epass.html');
	}
