...
class SjreloginAction extends BaseAction
{
    public function index()
    {
		...
		$sjblist=$this->bannerlists(486,2);
		...
		$this->assign('lan',$lan);
		if($_GET['lg']=='lg') $this->display('./GZphp/Tpl/Home/'.SHOUJIZHANOK.'/'.$foldername.'_lg.html');
		else if($_GET['lg']=='codes') $this->display('./GZphp/Tpl/Home/'.SHOUJIZHANOK.'/'.$foldername.'_codes.html');
